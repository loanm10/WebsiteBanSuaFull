                                            ...
                                            <div class="product-container text-left product-block">
                                                <div class="product-image-container image">
                                                    ...
                                                    <div class="tool-funtion">
                                                        <div class="quickview">
                                                            <a class="quick-view btn btn-outline " href="#quick-view-product" data-handle="nullam-volutpat" title="+ Like">
                                                                <i class="fa fa-thumbs-up"></i>
                                                                <span>+ Like</span>
                                                            </a>
                                                        </div>
                                                        <div class="share">
                                                            <a class="share-view btn btn-outline " href="http://www.facebook.com/sharer.php?u={{ route('web.product_detail',['id'=>$product->id,'name'=>$product->slug]) }}" data-handle="donec-fringilla" title="+ Share">
