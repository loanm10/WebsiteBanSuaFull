							...
							<div class="product-container text-left product-block">
								<div class="product-image-container image">
									...
									<div class="tool-funtion">
										<div class="quickview">
											<a class="quick-view btn btn-outline " href="#quick-view-product" data-handle="donec-fringilla" title="+ Like">
												<i class="fa fa-thumbs-up"></i>
												<span>+ Like</span>
											</a>
										</div>
										<div class="share">
											<a class="share-view btn btn-outline " href="#share" data-handle="donec-fringilla" title="+ Share">
